...
def generate_nodes_multiple(content, amr_nodes_content, amr_nodes_acronym):
    ...
    predict_event=re.search('[-\w\"]*\s/\s[-\w\"]*', content).group().split(' / ')
    if predict_event:
...
#     '''
#     nodeAMR = senteg.amr_nodes[nodeKey]
...
# print(" Node ", nodeNames)
# print(" First occurences ", allNamesFirst)

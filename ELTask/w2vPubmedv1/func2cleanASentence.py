...
## remove \n\r\some_character 
	...
	table = {ord(s): unicode(outtab) for s in list(punc2remove)}
	textInFile = textInFile.translate(table)
	...
	# stopwords += [ 'all', 'almost', 'alone', 'along']
	...
	# stopwords += ['beside', 'besides', 'between', 'bill']
	...
	# stopwords += ['still', 'such', 'take']
	# stopwords += ['ten', 'than', 'that', 'the', 'their', 'them', 'themselves']
	# stopwords += ['then', 'thence', 'there', 'thereafter', 'thereby']
	# stopwords += ['therefore', 'therein', 'thereupon', 'these', 'they']
	# stopwords += ['thick', 'thin', 'third', 'this', 'those', 'though', 'three']
	# stopwords += ['three', 'thru', 'thus', 'to']
